...
class TORTU_ORGANIZE_IMAGES:
    ...
    CATEGORY = "🐢 TORTU/FileMan"

    def __init__(self):
        self.processed_count = 0

    def organize_images(self, base_directory, project_name, **kwargs):
...
NODE_CLASS_MAPPINGS = {
    "TORTU_ORGANIZE_IMAGES": TORTU_ORGANIZE_IMAGES
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "TORTU_ORGANIZE_IMAGES": "🐢 Organize Images"
}