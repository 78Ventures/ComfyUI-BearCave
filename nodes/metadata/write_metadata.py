...
class TORTU_METADATA_WRITER:
    ...
    CATEGORY = "🐢 TORTU/Output"

    def write_metadata(self, image_batch, output_path, **kwargs):
...
NODE_CLASS_MAPPINGS = {
    "TORTU_METADATA_WRITER": TORTU_METADATA_WRITER
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "TORTU_METADATA_WRITER": "🐢 Metadata Writer"
}